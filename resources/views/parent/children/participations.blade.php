...
@section('content')
    ...
    <header class="mb-4 sm:mb-6 rounded-xl sm:rounded-2xl bg-gradient-to-r from-[#04371f] to-[#04371f]/80 p-4 sm:p-6 text-white shadow-xl flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <p class="text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.2em] text-[#a48834] mb-1">PARTICIPATION DE L'ENFANT</p>
        ...
        <a href="{{ route('parent.children.competitions', $student->id) }}" class="inline-flex w-full sm:w-auto items-center justify-center rounded-lg bg-white/20 px-4 py-2.5 sm:py-2 text-sm font-medium text-white hover:bg-white/30 backdrop-blur-sm transition shadow-sm border border-white/10">
    ...
    <div class="mx-auto max-w-6xl space-y-6 pb-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="rounded-2xl bg-white p-4 sm:p-5 shadow-sm border border-slate-100 flex flex-col justify-between">
                <p class="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-slate-500">Statut de l'enfant</p>

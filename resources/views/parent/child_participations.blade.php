...
<div class="px-2 sm:px-4 py-4">
    ...
    <header class="mb-6 rounded-2xl bg-gradient-to-r from-[#04371f] to-[#04371f]/80 p-6 text-white shadow-xl flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <p class="text-[10px] font-bold uppercase tracking-[0.2em] text-[#a48834] mb-1">PARTICIPATION DE L'ENFANT</p>
        ...
        <a href="{{ route('parent.children.competitions', $student->id) }}" class="inline-flex items-center justify-center rounded-lg bg-white/20 px-4 py-2 text-sm font-medium text-white hover:bg-white/30 backdrop-blur-sm transition">
            Retour
        </a>
    </header>
    ...
    <div class="mx-auto max-w-6xl space-y-6">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <div class="rounded-2xl bg-white p-5 shadow-sm border border-slate-100 flex flex-col justify-between">
                <p class="text-xs font-bold uppercase tracking-wider text-slate-500">Statut de l'enfant</p>
                 ...
                 <div class="rounded-2xl bg-white shadow-sm border border-slate-100 overflow-hidden">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                             ...
                             <div class="space-y-6">
                                <div>
                                    <h3 class="text-xs font-bold text-[#a48834] uppercase tracking-widest mb-3">Informations Enfant</h3>
                             ...
                             <!-- Remarque Section -->
                             <div>
                                <h3 class="text-xs font-bold text-[#a48834] uppercase tracking-widest mb-3">Remarques du Cheikh</h3>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="space-y-4 text-sm">
                                <div>
                                    <p class="text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">Date de début</p>
                                    <p class="font-medium text-slate-700">{{ \Carbon\Carbon::parse($competition->date_debut)->format('d/m/Y') }}</p>
                                </div>
                                <div>
                                    <p class="text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">Date de fin</p>
                                    <p class="font-medium text-slate-700">{{ \Carbon\Carbon::parse($competition->date_fin)->format('d/m/Y') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>

        ...
        <table class="min-w-full text-sm">
            <thead class="bg-slate-50 text-left">
                <tr>
                    ...
                    <th class="px-3 py-3">Nom halaqa</th>
                    <th class="px-3 py-3">Capacite</th>
                    <th class="px-3 py-3">Etudiants</th>
            ...
            <tbody>
                @forelse ($halaqas as $halaqa)
                    <tr class="border-t border-slate-100">
                        <td class="px-3 py-3">{{ $halaqa->id }}</td>
                        <td class="px-3 py-3">{{ $halaqa->nom_halaqa }}</td>
                        <td class="px-3 py-3">{{ $halaqa->capacite }}</td>
                        <td class="px-3 py-3">{{ $halaqa->students->count() }}</td>
                        <td class="px-3 py-3">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-3 py-6 text-center text-slate-500">Aucune halaqa disponible.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
